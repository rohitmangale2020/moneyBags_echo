...
public class ProductController {
    ...
    @DeleteMapping("/{productCode}") @PreAuthorize("hasRole('ADMIN')") @ResponseStatus(HttpStatus.NO_CONTENT) public void retire(@PathVariable String productCode) { service.retire(productCode); }
}
