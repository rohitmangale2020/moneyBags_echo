...
import { u as useTabBarContext } from './TabBarLayout-9b67d1b6.js';
...
import { I as Icon } from './Icon-96679294.js';
import { D as Dropdown } from './Dropdown-63170b62.js';
...
import { b as boxAlignmentInterpolations } from './boxalignment-8980856d.js';
...
import { u as useConveyorBeltItem } from './useConveyorBeltItem-1b9081e3.js';
...
import { u as useTabBarItemTooltip, N as NavigationListLinkItem, R as RemovableNavigationListItem } from './NavigationListLinkItem-99c5b4e5.js';
...
import { N as NavigationList, a as NavigationListItem } from './NavigationListItem-aca16c7a.js';
...
function BaseTabBarItem({ itemKey, label, icon, badge, metadata, severity = 'none', removeIcon, showFocusRingOverride, selectionOverride, displayOverride, labelMaxWidth, href, 'aria-controls': ariaControls, 'aria-haspopup': ariaHasPopup }) {
    ...
    const tabBarLinkItemRenderer = () => {
        const safeHref = getSafeHref(href, 'TabBar');
        return (jsxs("span", { ref: ref, class: tabBarItem, ...mergeProps(pressProps, tooltipEventHandlerProps, conveyorBeltProps), style: isComplexItem ? flexDimensions : tabDimensions, children: [jsx("a", { onClick: onClickLink, class: tabBarItemLinkClasses, href: safeHref, "data-oj-key": itemKey, "data-oj-removable": removeIcon ? 'true' : undefined, id: tabItemPrefix + itemKey, role: "tab", tabindex: -1, "aria-controls": ariaControls, "aria-selected": isSelected, "aria-haspopup": ariaHasPopup, children: isComplexItem ? complexItemRenderer() : labelIconRenderer() }), tooltipContent] }));
    };
...
//# sourceMappingURL=OverflowTabBarItem-817b089a.js.map
