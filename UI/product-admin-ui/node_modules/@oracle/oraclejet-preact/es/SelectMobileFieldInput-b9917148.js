...
import { c as preventDefaultForCurrentTarget } from './useSelectCommon-34b231da.js';
...
const DROPDOWN_OFFSET = { mainAxis: 4, crossAxis: 0 };
const DROPDOWN_SIZE_OPTIONS = {
    isMaxHeightAdjusted: true,
    maxHeightCeiling: 400
};
const DROPDOWN_SHIFT_OPTIONS = {
    mainAxis: false
};
...
function Dropdown({ anchorRef, children, dropdownRef, id, isOpen, onAutoDismiss, onPosition }) {
    ...
    const inlineStyle = isOpen
        ...
        : {};
    return !isOpen ? null : (jsx(Layer, { logicalParentRef: anchorRef, children: jsx(Floating, { anchorRef: anchorRef, sizeOptions: DROPDOWN_SIZE_OPTIONS, shiftOptions: DROPDOWN_SHIFT_OPTIONS, ref: dropdownRef, placement: placement, offsetValue: DROPDOWN_OFFSET, onPosition: handlePosition, children: jsx("div", { class: dropdownStyles.base, id: id, style: inlineStyle, onKeyDown: handleKeyDown, onMouseDown: preventDefaultForCurrentTarget, children: children }) }) }));
}
...
//# sourceMappingURL=SelectMobileFieldInput-b9917148.js.map
