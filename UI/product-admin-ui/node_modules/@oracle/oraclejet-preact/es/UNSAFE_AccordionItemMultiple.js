...
import { C as Collapsible } from './Collapsible-9df0dd24.js';
...
import './CollapseIcon-d6a9d390.js';
...
function AccordionItemMultiple({ 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledby, children, isDisabled, header, iconPosition, itemKey, expandedKeys, onChange, onTransitionEnd, testId }) {
    ...
    const seenExpandedKeysRef = useRef(expandedKeys);
    const prevExpandedKeysRef = useRef();
    ...
    const onToggleHandler = useCallback((detail) => {
        handleToggle(detail, itemKey, expandedKeys, onChange);
    }, [itemKey, expandedKeys, onChange]);
    const toggleHandler = useCallback((detail) => {
    ...
    return (jsx("div", { ...testIdProps, children: jsx(AccordionItemStylingContext.Provider, { value: { stylingVariant: 'accordion' }, children: jsx(Collapsible, { "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, isDisabled: isDisabled, isExpanded: isExpanded, header: header, iconPosition: iconPosition, variant: 'basic', onToggle: toggleHandler, onTransitionEnd: handleOnTransitionEnd, children: children }) }) }));
}
const keysEqual = (a, b) => {
    if (!a || !b)
        return false;
