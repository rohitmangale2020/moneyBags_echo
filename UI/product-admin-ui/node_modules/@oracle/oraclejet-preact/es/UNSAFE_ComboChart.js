...
import { t as getSeriesData, l as getLineAreaSegments, n as getBarGapRatio, o as findNearestDataPoint, s as getMarkers, p as getStartAndEndAxesOffset } from './utils-24c54d43.js';
import { A as AreaSeries, L as LineSeries } from './ReferenceLineArea-53129f72.js';
import { M as MarkersWithLabel } from './MarkersWithLabel-a838355c.js';
import { e as getLineAreaChartNavUtil, d as getItemColor, f as getMarkerType } from './dataStyleUtils-82159c06.js';
import { u as useUser } from './useUser-06d34d19.js';
import { g as getColorRamp } from './colorUtils-77b8874f.js';
import './accUtils-9d5183c4.js';
import { c as colorSchemeVars } from './themeContract.css-1ffed3bf.js';
import { B as BarGroup, g as getBarPosition } from './BarGroup-3c121a3c.js';
import { g as getLineAreaChartItemPosition } from './chartUtils-edefe22f.js';
import { forwardRef } from 'preact/compat';
import { C as Chart } from './Chart-1c763f58.js';
...
import './labelUtils-e347bdbe.js';
import './textUtils-3ed25dd1.js';
import './utils-49903d04.js';
...
import './TrackResizeContainer-3d7b18b7.js';
...
import './useChartDatatip-e4009610.js';
import './useDatatip-710f97c7.js';
...
import './cssUtils-9e0e0351.js';
import './useChartContextMenu-41b18037.js';
import './useContextMenu-2c5034a4.js';
import './SelectMenuGroupContext-6ee1b1e1.js';
...
import './useChartDnd-aa8bc33b.js';
import './utils-8e622bdf.js';
...
import './ButtonSetItem-6d8fcfc6.js';
import './ButtonSetButton-61b88d81.js';
import './ToggleButtonLabel-d126a549.js';
...
import './ButtonSetIconButton-480cff44.js';
import './useButtonSetPositionContext-1dc5156a.js';
import './IconToggleButton-fe8d0e55.js';
...
import './useVisTouchResponse-a59ab166.js';
import './useOverviewContext-79377674.js';
import './OverviewSlidingWindow-daac7a6a.js';
 ...
 */
const ComboChart = forwardRef(({ width, height, selectedIds = [], hiddenIds = [], highlightedIds, hideAndShowBehavior = 'none', orientation = 'vertical', yAxis, series, groups, getDataItem, selectionMode = 'none', drilling = 'off', dataItemGaps = 0.5, dataLabelEffect = 'outline', stacking = 'off', ...props }, ref) => {
    ...
    let renderedSeries = getSeriesData(series.length, groups.length, getDataItem, hiddenSet, isLog);
    ...
    const getDataItemPos = (xScale, yScale, y2Scale, axisStepWidth, averageGroupZ, gapRatio) => {
        const _getBarPosition = hasBar
            ? getBarPosition(filteredBarSeries, groups, getDataItem, xScale, yScale, y2Scale, hiddenSet, dataItemGaps, axisStepWidth, averageGroupZ, gapRatio, yAxis?.scale === 'log', isStacked, isRtl, isHoriz, isSplitDualY, getStackGroup, timeAxisType)
            : undefined;
        return (seriesIndex, groupIndex) => {
            ...
            if (seriesItem.type === 'bar') {
                ...
                return getLineAreaChartItemPosition(seriesIndex, groupIndex, renderedSeries, getDataItem, groups, isHoriz, xScale, yScale, timeAxisType);
            }
        };
    };
    ...
    const findNearest = (xScale, yScale, y2Scale) => {
        ...
        return findNearestDataPoint(series, groups, xScale, yScale, renderedGetDataItem, isStacked, getSeriesDataInfo, getYCoord, isLog, 0, hiddenSet, timeAxisType, y2Scale);
    };
    ...
    const getOffset = (groupCount) => {
        return getStartAndEndAxesOffset(hasCenteredSeries, hasUncenteredSeries, isHoriz, groupCount, hasBar);
    };
    return (jsx(Chart, { ref: ref, width: width, height: height, selectedIds: selectedSet, hiddenIds: hiddenIds, hideAndShowBehavior: hideAndShowBehavior, orientation: orientation, yAxis: yAxis, series: series, defaultOverviewContentRenderer: () => {
            return jsx(OverviewComboChart, { groups: groups, series: series, getDataItem: getDataItem });
            ...
            renderedSeries = getSeriesData(series.length, leafGroups.length, getDataItem, hiddenSet, isLog);
            return (jsx(Fragment, { children: renderedSeries.map((valueSeries, index) => {
                    ...
                    const lineSegmentCoords = getLineAreaSegments(isAssociatedToY2 ? y2Scale : yScale, xScale, valueSeries, xStartIndex, xEndIndex, isLog, leafGroups, index, renderedGetDataItem, timeAxisType);
...
function OverviewComboChart(props) {
    return (jsx(ComboChart, { datatip: () => ({ content: '' }), zoomAndScroll: "off", plotArea: {
            yMajorTick: {
                isRendered: false
            },
            xMajorTick: {}
