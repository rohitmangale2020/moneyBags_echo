...
import { S as SvgDragV } from './DragV-e701f050.js';
...
function DragHandle({ testId }) {
    ...
    return (jsx("div", { ...mergeProps(activeProps, testIdProps), "data-oj-draggable": "", draggable: true, class: classes, role: "presentation", children: jsx(SvgDragV, {}) }));
}
