...
import { forwardRef, useRef as useRef$1, useImperativeHandle as useImperativeHandle$1, useCallback as useCallback$1 } from 'preact/compat';
...
import { b as isBackspaceOrDelete, a as isSelectAll, K as KEYS, i as isControlOrFunctionKey } from './keyboardUtils-986fe923.js';
import { T as TextFieldInput, R as ReadonlyTextField } from './StyledTextField-64f0929e.js';
...
import { a as DropdownUserAssistance, L as LinkItem, D as Dropdown, S as SelectMobileDropdown, b as SelectMobileFieldInput } from './SelectMobileFieldInput-b9917148.js';
import { E as EmptyResults, p as preventDefault, b as DropdownList, a as DropdownArrow, r as renderItemText, j as isSearchTextEmptyOrUndefined, m as createKeysFromValueItems, u as useCollectionRenderer, d as useSelectCommon, h as isBeforeDataFetch, f as isPhone, s as shouldIgnoreSelectInputKeyDownDuringComposition, l as shouldIgnoreSelectInputKeyUpDuringComposition, D as DefaultList, e as isMobile, g as isTablet } from './useSelectCommon-34b231da.js';
...
import { C as Chip } from './Chip-4efea02e.js';
import { I as IconButton } from './IconButton-bb390936.js';
import { S as SvgNavLeft, a as SvgCancelS } from './NavLeft-b817ddb3.js';
...
import { S as SvgClose } from './Close-4df029ac.js';
...
import { V as View } from './View-5bdd9b3c.js';
import { mobileDropdownFooterStyles } from './UNSAFE_SelectMultiple/themes/MobileDropdownFooterStyles.css.js';
import { B as Button } from './Button-1a5604c2.js';
import { u as useEffectEvent } from './useEffectEvent-1bb008cb.js';
import { e as equals } from './equals-625352e8.js';
import { m as mergeProps } from './mergeProps-88ea8306.js';
import { l } from './stringUtils-0fe25200.js';
import { u as useHiddenTestMethod } from './useHiddenTestMethod-f3f25093.js';
...
import './CompactLabelAssistance-5d20a2c9.js';
import './useTabbableMode-090ed4b5.js';
import './Help-93fa3375.js';
...
import './LabelValueLayout-e8167a67.js';
...
import './ErrorS-7172750a.js';
import './InformationS-1688c956.js';
import './WarningS-4edd2831.js';
import './PRIVATE_Message/themes/MessageStyles.css.js';
import './soundUtils-dbc57080.js';
...
import './HighlightText-0205faef.js';
...
import './ListItemText-d001751c.js';
import './List-3ed2c0e8.js';
...
import './LoadMoreCollection-d9f22790.js';
import './Collection-e1ef8b8d.js';
import './useViewportIntersect-6ff65310.js';
import './VirtualizedCollection-0160e675.js';
import './useNavigation-ef11265f.js';
...
import './useTabbableModeSet-cce73d79.js';
...
import './useItemAction-fc19998c.js';
import './Inset-8afb9876.js';
...
function SelectMultipleDesktopDropdown({ assistiveText, collectionRenderer, collectionRendererContext, data, dropdownId, dropdownRef, helpSourceLink, helpSourceText, isAddToListShown, isDisabled, isDropdownAbove, isEmptyResults, isOpen, isReadonly, label, mainFieldRef, userAssistanceDensity, onAddToListAction, onAutoDismiss, onPosition }) {
    ...
    const dropdownListContent = isEmptyResults ? (isAddToListShown ? undefined : (jsx(EmptyResults, {}))) : (collectionRenderer(collectionRendererContext));
...
function TextTag({ children, removeIcon = 'never', isSelected = false, onRemoveAction, onSelect, onRemoveIconClick, isFocused, value }) {
    ...
    return (jsxs(Fragment, { children: [jsxs("span", { ref: spanRef, class: rootClasses, tabIndex: -1, onClick: onSelectCallback, onKeyUp: onKeyUp, 
                ...
                onMouseDown: preventDefault, role: "option", "aria-describedby": removeIcon === 'never' ? navigationTextId : undefined, "aria-selected": isSelected ? 'true' : 'false', children: [jsx(Text, { size: "md", variant: "inherit", children: children }), removeIcon === 'always' && (jsx(TabbableModeContext.Provider, { value: { isTabbable: false }, children: jsx(IconButton, { size: "xs", variant: "ghost", onAction: onRemoveIconClickCallback, children: jsx(SvgClose, {}) }) }))] }), 
            ...
            removeIcon === 'never' && (jsx(HiddenAccessible, { id: navigationTextId, children: translations.selectMultiple_removeSelectedTagInstructionText() }))] }));
}
...
function createDisplayValues(itemText, selectedItems) {
    ...
    const mapFunc = (itemContext) => renderItemText(itemContext, itemText, 'SelectMultiple');
    const mappedArray = arValues.map(mapFunc);
    return new Set(mappedArray);
}
function createTextTags(itemText, selectedItems = []) {
    return selectedItems.map((item) => ({
        label: renderItemText(item, itemText, 'SelectMultiple') ?? '',
        value: item.key
    }));
}
...
function useMobileDropdown({ data, inputRef, isDropdownOpen, isDropdownSelectedOnlyView, itemText, textTagListRef, userInput, valueItems, onCommit, setDropdownOpen, setUserInput, stopFiltering }) {
    ...
    const [dropdownSelectedKeys, setDropdownSelectedKeys] = useState(createKeysFromValueItems(valueItems));
    ...
    const onSelectedKeysChange = useCallback((detail) => {
...
function useSelectMultiple({ addToList, ariaDescribedBy, data: propData, inputRef, isDisabled, isFocused: propIsFocused, isReadonly, onAddToListAction, onCommit, onFilter, valueItems }) {
    ...
    const combinedAriaDescribedBy = l([
    ...
    const shouldSelectCurrentRow = useCallback((currentRowKey) => {
    ...
    const handleInputKeyDown = useCallback((event) => {
        ...
        if (shouldIgnoreSelectInputKeyDownDuringComposition(event)) {
            return;
        }
    ...
    const handleInputKeyUp = useCallback((event) => {
        ...
        if (shouldIgnoreSelectInputKeyUpDuringComposition(event)) {
            return;
        }
...
const SelectMultiple = forwardRef(({ addToList = 'off', 'aria-describedby': propAriaDescribedBy, assistiveText, collectionRenderer, columnSpan, data: propData, helpSourceLink, helpSourceText, isDisabled: propIsDisabled, isLoading: propIsLoading, isReadonly: propIsReadonly, isRequired, isRequiredShown, itemRenderer, itemText, label, labelEdge: propLabelEdge, labelStartWidth: propLabelStartWidth, messages, onAddToListAction, onCommit, onFilter, onLoadRange, placeholder, testId, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, valueItems, variant = 'default', virtualKeyboard }, ref) => {
    ...
    const enabledElementRef = useRef$1(null);
    const readonlyElementRef = useRef$1(null);
    ...
    useImperativeHandle$1(ref, () => focusMethods, [focusMethods]);
    ...
    const dropdown = !shouldShowDropdown ? null : isPhone() ? (jsx(SelectMultipleMobileDropdown, { "aria-describedby": ariaProps.ariaDescribedBy, "aria-label": ariaLabel, assistiveText: assistiveText, collectionRenderer: collectionRenderer ?? defaultCollectionRenderer, 
