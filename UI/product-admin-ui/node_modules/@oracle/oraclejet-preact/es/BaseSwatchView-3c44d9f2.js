...
import { m as compareListItemContext, k as keyExtractor, f as findElementByKey, j as getViewportConfig, l as getPrevNextKeyByCount, b as getFirstVisibleKey } from './collectionUtils-609f73d6.js';
...
import { u as useSwatchSelection } from './useSwatchSelection-1757379d.js';
...
const BaseSwatchViewImpl = forwardRef(({ children, data, onLoadMore = () => { }, hasMore = false, getRowKey, currentKey, onCurrentKeyChange, selectedKeys = emptyKeys, onSelectionChange, viewportConfig, focusBehavior = 'swatch', 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, columns, swatchSize, updateSwatchSize }, ref) => {
    ...
    /*****************************************************************************************/
    const { currentKeyProps } = useCurrentKey((element) => keyExtractor(element, ITEM_SELECTOR), true, isCurrentTabbableKey(currentKey), 
...
//# sourceMappingURL=BaseSwatchView-3c44d9f2.js.map
