...
import { u as useMessageFocusManager } from './useMessagesFocusManager-d7a9b9ce.js';
...
import { M as Message } from './Message-aac08650.js';
import 'preact';
...
import { c as getLiveRegionTextByDevice, b as MessagesManager, g as getRenderer } from './MessagesManager-98126752.js';
...
import { M as MessageLayer } from './MessageLayer-69878fee.js';
...
function MessageToast({ data, detailRendererKey, iconRendererKey, renderers, onClose, offset, position, testId }) {
    ...
    const { controller, handlers } = useMessageFocusManager(focusHandleRef, {
        onFocus: useCallback(() => {
            setLiveRegionText(getLiveRegionTextByDevice('from', deviceType, translations));
    ...
    const onCloseHandler = useCallback((item, actionDetail) => {
    ...
    useEffect(() => {
        ...
        if (data.length) {
            ...
            if (data.length > previousDataLength) {
                ...
                setLiveRegionText(getLiveRegionTextByDevice('to', deviceType, translations));
            }
