...
import { c as getItemKeysArray, a as getKey } from './collectionUtils-609f73d6.js';
...
function useReorderableItem(options) {
    ...
    useEffect(() => {
        if (ref.current) {
            const item = getItem();
            const key = item != null ? getKey(item) : undefined;
            setItemKey(key);
        }
    }, [dragKey]);
...
export { useReorderableItem as a, useReorderable as u };
//# sourceMappingURL=useReorderableItem-017bc1fc.js.map
