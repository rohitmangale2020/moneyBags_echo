...
import { m as moveTo, a as arcTo, l as lineTo, b as closePath } from './lineUtils-87255164.js';
import { i as getAvailSpace } from './utils-24c54d43.js';
import { c as classNames } from './classNames-4e12b00d.js';
import { u as usePieChartNav } from './usePieChartNav-5c27d2cd.js';
...
import { g as getInfo } from './eventsUtils-14cb0a49.js';
...
function PieChartWithDimensions({ width, height, testId, innerRadius = 0, contextMenuConfig, drilling = 'off', selectionMode = 'none', onItemDrill, onItemHover, onItemFocus, ...props }) {
    ...
    return (jsxs("div", { ref: rootRef, tabIndex: 0, "aria-label": props['aria-label'], "aria-labelledby": props['aria-labelledby'], "aria-activedescendant": activeId, role: "application", ...mergedProps, ...testIdProps, className: styles.chart, style: touchResponseStyle, children: [renderedSlices.length > 0 && hasData && ( //className={styles.svg}
            jsxs("svg", { className: styles.svg, children: [renderedSlices.map((item, index) => {
...
function PieChart({ width, height, ...props }) {
    return (jsx(TrackResizeContainer, { width: width, height: height, class: dimensionStyle, children: (w, h) => (jsx(PieChartWithDimensions, { width: w, height: h, ...props })) }));
}
