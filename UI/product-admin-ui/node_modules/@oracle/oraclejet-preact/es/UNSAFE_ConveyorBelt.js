...
import { useState, useRef, useMemo, useCallback, useEffect, useContext } from 'preact/hooks';
import { B as BaseButton } from './BaseButton-e8e5bfe4.js';
import { B as ButtonLabelLayout } from './ButtonLabelLayout-02656ee2.js';
import { S as SvgChevronLeft } from './ChevronLeft-efff4aa3.js';
import { S as SvgChevronRight } from './ChevronRight-500bb8c7.js';
import { S as SvgChevronUp } from './ChevronUp-3c01b078.js';
import { S as SvgChevronDown } from './ChevronDown-63b88479.js';
...
import { C as ConveyorBeltFocusContext } from './ConveyorBeltFocusContext-dd3cf192.js';
export { C as ConveyorBeltFocusContext } from './ConveyorBeltFocusContext-dd3cf192.js';
...
const ConveyorBelt = forwardRef(({ children, scrollPosition, onScrollPositionChanged, arrowVisibility = 'auto', orientation = 'horizontal', testId }, ref = null) => {
    ...
    const _getConveyorItems = useCallback(() => {
    ...
    const focusContext = useContext(ConveyorBeltFocusContext);
    ...
    const onOverflowFocus = useCallback(() => {
