...
function validateAudioURL(url) {
    ...
    if (ALLOWED_AUDIO_URL_PROTOCOLS.indexOf(protocol) < 0) {
...
export { playAudioFromURL as a, playDefaultNotificationSound as p };
//# sourceMappingURL=soundUtils-dbc57080.js.map
