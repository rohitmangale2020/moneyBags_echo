...
import { w as warn, e as error, i as info, l as log } from './logger-35b2acf7.js';
import { p as playDefaultNotificationSound, a as playAudioFromURL } from './soundUtils-dbc57080.js';
...
const getLiveRegionTextByDevice = (context, deviceType, translations) => {
    const gesture = ['phone', 'tablet'].includes(deviceType) ? 'touch' : 'keyboard';
    const keys = {
        to: {
            touch: 'message_navigationToTouch',
            keyboard: 'message_navigationToMessagesRegion'
        },
        from: {
            touch: '',
            keyboard: 'message_navigationFromMessagesRegion'
        }
    };
    const message = keys[context][gesture];
    return message ? translations[message] : '';
};
...
export { MessageStartIcon as M, MessageSummary as a, MessagesManager as b, getLiveRegionTextByDevice as c, getRenderer as g, isSeverityIconNeeded as i, playSound as p, severityBasedStyleClass as s, throwError as t };
//# sourceMappingURL=MessagesManager-98126752.js.map
