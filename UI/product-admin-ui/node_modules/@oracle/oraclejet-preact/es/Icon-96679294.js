 ...
 */
const Icon = ({ size = '1em', color = 'currentColor', accessibleLabel = '', viewBox = 'none', children }) => {
    ...
    if (browser === 'safari') {
        ...
        return (jsx(Svg, { viewBox: viewBox, accessibleLabel: accessibleLabel, class: styles[color], style: { width: sideLength, height: sideLength }, children: children }));
    }
    return (jsx(Svg, { height: "1em", width: "1em", viewBox: viewBox, accessibleLabel: accessibleLabel, class: styles[color], style: { fontSize: size === '1em' ? size : `${sizeToCSS(size)}` }, children: children }));
};
...
export { Icon as I };
//# sourceMappingURL=Icon-96679294.js.map
