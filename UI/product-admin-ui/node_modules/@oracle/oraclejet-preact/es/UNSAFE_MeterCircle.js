...
import { v as validateRange, h as hasLabelledReferenceLine, c as getMaxRefLabelDims, g as getMeterAriaProps, b as getTrackAndIndicatorColor, d as getDefaultReferenceLineLabelFontSize } from './meterUtils-19c07f4c.js';
...
import { c as colorSchemeVars, t as typographyVars } from './themeContract.css-1ffed3bf.js';
...
function FitMeterCircle({ max = 100, min = 0, value = 0, step = 1, size = 'fit', startAngle = 90, angleExtent = 360, isTrackRendered = true, thresholdDisplay = 'all', indicatorSize = 1, testId, isReadonly, ...props }) {
    ...
    validateRange(min, max, value, step, false, isReadonly);
