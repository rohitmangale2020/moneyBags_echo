...
import { useRef, useCallback, useEffect, useMemo, useLayoutEffect, useReducer, useImperativeHandle } from 'preact/hooks';
...
import { g as getAmPmMatchType, A as AM_VALUE$1, P as PM_VALUE$1, h as hasSegmentsNotDisplayed, d as displayedTimeSegmentsAreDifferent, a as getHourValueStr, b as getDayPeriodValueStr, c as getDayPeriodValueFromHour, p as padWithZero, e as getAmPmStringsForLocale, t as timesAreDifferent, f as formatTimeFromMasks, r as replaceCustomMasksValuesWithPlaceholders, i as getTimeMasksFromLocaleAndOptions, j as getLeadingZeroForHour } from './timeUtils-4d0b2577.js';
...
import './getFormatParse-0b8d78e0.js';
import { i as isNumberOnlyString, w as withinRange, s as stringToNumber, n as numberToString } from './maskUtils-b16a22c0.js';
...
import './calendarDateUtils-a6baf09c.js';
...
const LiteralSegment = ({ isHidden, isHighlighted, isPlaceholder, text }) => {
    ...
    return (jsx("span", { "aria-hidden": "true", class: spanClasses, children: isTextOnlyWhitespace ? ' ' : text }));
};
...
const TimeField = ({ 'aria-describedby': describedBy, 'aria-invalid': ariaInvalid, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, baseId, dispatch, fieldRef, granularity = 'minute', hasLeadingZeroForHour, hasInsideLabel, isRequired, masks: timeMasks, onBlur, onCommit, onFocus, onInput, state, testId, textAlign, value, variant = 'default' }) => {
    ...
    return (jsxs("div", { "aria-describedby": ariaDescribedBy, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, class: compClasses, onFocusIn: onFocus, onFocusOut: onBlur, ref: groupRef, role: "group", tabIndex: tabIndex, ...timeFieldHandlers, children: [jsx(Flex, { direction: "row", wrap: "nowrap", justify: textAlign, height: "100%", align: "center", children: timeMasks.map(({ type, value: placeholder }) => {
                    if (type === 'literal') {
                        ...
                        return (jsx(TimeSegment, { inputRef: type === firstSegmentType ? fieldRef : undefined, isDisabled: isDisabled, isFieldFocused: isFocused, isInvalid: !!ariaInvalid, isHidden: isHidden, isHighlighted: isTimeSelected, isRequired: isRequired, placeholder: placeholder, ...segmentHandlers, ...segmentProps }));
                    }
                    return null;
...
const InputTimeMask = forwardRef(({ 'aria-describedby': ariaDescribedBy, assistiveText, columnSpan, endContent, granularity = 'minute', helpSourceLink, helpSourceText, hourClock = 'fromLocale', isDisabled: propIsDisabled, isReadonly: propIsReadonly, isRequired, isRequiredShown, label, labelEdge: propLabelEdge, labelStartWidth: propLabelStartWidth, leadingZeroForHour = 'fromLocale', mainFieldRef, messages, masks, testId, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, value, variant, onCommit, onInput }, ref) => {
    ...
    const onTimeFieldFocusOut = useCallback((event) => {
    ...
    const mainContent = (jsx(TimeField, { "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, baseId: baseId, dispatch: dispatch, fieldRef: enabledElementRef, granularity: granularity, hasInsideLabel: labelComp !== undefined && labelEdge === 'inside', hasLeadingZeroForHour: resolvedHasLeadingZeroForHour, isRequired: isRequired, masks: timeMasks, onBlur: handleTimeFieldBlur, onCommit: onCommit, onInput: onInput, state: state, testId: testId ? testId + '_timeField' : undefined, textAlign: textAlign, value: value, ...timeFieldProps }));
