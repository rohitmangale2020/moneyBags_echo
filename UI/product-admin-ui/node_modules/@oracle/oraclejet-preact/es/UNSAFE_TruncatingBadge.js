...
import { u as useTooltipOnTruncation } from './useTooltipOnTruncation-f7a0a7a9.js';
...
function TruncatingBadge({ variant, size, edge, children }) {
    ...
    const { tooltipOnTruncationProps, tooltipContent, isTextTruncated } = useTooltipOnTruncation(children);
    return (jsxs(Fragment, { children: [jsx("span", { ...tooltipOnTruncationProps, tabIndex: isTextTruncated && isTabbable ? 0 : -1, class: classes, children: children }), tooltipContent] }));
}

export { TruncatingBadge };
