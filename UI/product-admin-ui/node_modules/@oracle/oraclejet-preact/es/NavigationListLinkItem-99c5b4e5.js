...
import { E as EmbeddedIconButton } from './EmbeddedIconButton-a1aadc89.js';
...
import { u as useTooltipControlled } from './useTooltipControlled-af42d1d6.js';
...
function BaseNavigationListItem({ itemKey, label, badge, metadata, severity = 'none', removeIcon, icon, href, 'aria-controls': ariaControls }) {
    ...
    const navlistLinkItemRenderer = () => {
        const safeHref = getSafeHref(href, 'NavigationList');
        return (jsx("div", { ...itemHandlers, class: itemClasses, children: jsx("a", { tabindex: -1, role: "tab", "data-oj-key": itemKey, id: itemId, class: navigationItemLinkClass, "aria-selected": isSelected, "aria-controls": ariaControls, href: safeHref, onClick: onClickLink, children: isComplexItem ? complexItemRenderer() : labelRenderer() }) }));
    };
...
//# sourceMappingURL=NavigationListLinkItem-99c5b4e5.js.map
