...
import { S as SvgCalendar } from './Calendar-147ff3fc.js';
...
import { D as DatePicker } from './DatePicker-4d20c548.js';
...
import { c as calendarDatesAreDifferent } from './maskUtils-b16a22c0.js';
import { u as useHiddenTestMethod } from './useHiddenTestMethod-f3f25093.js';
import { y as isCompleteCalendarDate } from './calendarDateUtils-a6baf09c.js';
import { u as useTestId } from './useTestId-f24ac480.js';
import { a as InputDateMaskContext, I as InputDateMask } from './InputDateMask-80707fa6.js';
...
import './useBreakpointValues-93118b0e.js';
import './useBreakpoints-99efa183.js';
import './Button-1a5604c2.js';
...
import './DatePickerHeader-d0704e8e.js';
import './CaretDown-49d9c4fc.js';
import './ChevronLeft-efff4aa3.js';
import './ChevronRight-500bb8c7.js';
import './ToggleButton-4ec8c0ee.js';
...
import './MonthView-65906260.js';
import './dayUtils-d17b681f.js';
import './supplementalData-ed66ab4e.js';
import './StyledDatePickerButton-a7782821.js';
...
import './useCellNavigation-0565b6dd.js';
...
import './YearsGridView-5379d7af.js';
 ...
 */
const InputDatePickerDropdown = ({ anchorRef, assistiveText, dayFormatter, daysOutsideMonth, helpSourceLink, helpSourceText, isDisabled, isOpen, isReadonly, label, onClose, onCommit, max, messages, min, monthAndYearPicker, testId, todayButton, todayTimeZone, userAssistanceDensity, value, weekDisplay }) => {
    ...
    const datePickerMainContent = (jsx(DatePicker, { dayFormatter: dayFormatter, daysOutsideMonth: daysOutsideMonth, height: !shouldShowSheet ? 'auto' : undefined, onCommit: onCommit, max: max, min: min, 
        // for sheet, we want the width to grow to the width of the sheet, otherwise it will use the theme default.
        maxWidth: shouldShowSheet ? '100%' : undefined, width: "100%", monthAndYearPicker: monthAndYearPicker, testId: testId, todayTimeZone: todayTimeZone, todayButton: todayButton, value: value, weekDisplay: weekDisplay }));
 ...
 */
const useInputDatePicker = ({ isDisabled, isReadonly, onCommit, onInput, rootRef, value: currentValue }) => {
    ...
    const maskCommitHandler = useCallback((detail) => {
 ...
 */
const InputDatePicker = forwardRef(({ 'aria-describedby': propDescribedBy, assistiveText, dayFormatter, daysOutsideMonth, helpSourceLink, helpSourceText, isDisabled, isReadonly, label, max, messages, min, monthAndYearPicker, todayTimeZone, todayButton, value, onCommit, onInput, testId, userAssistanceDensity: propUserAssistanceDensity, weekDisplay, ...dateMaskProps }, ref) => {
    ...
    const ariaDescribedBy = !isDisabled && !isReadonly
        ? l([propDescribedBy, maskFieldInstructionId])
        : propDescribedBy;
    ...
    return (jsxs("div", { ...testIdProps, ref: rootRef, children: [jsx(InputDateMaskContext.Provider, { value: { isDropdownOpen: isOpen, isInputDatePickerParent: true }, children: jsx(InputDateMask, { "aria-describedby": ariaDescribedBy, assistiveText: assistiveText, endContent: endContent, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, isDisabled: isDisabled, isReadonly: isReadonly, label: label, onCommit: maskCommitHandler, onInput: maskInputHandler, mainFieldRef: mainFieldRef, messages: messages, testId: testId ? testId + '_mask' : undefined, ref: maskRef, userAssistanceDensity: propUserAssistanceDensity, value: dateValue, ...dateMaskProps }) }), maskFieldInstruction, shouldShowDropdown && (jsx(InputDatePickerDropdown, { anchorRef: mainFieldRef, assistiveText: assistiveText, dayFormatter: dayFormatter, daysOutsideMonth: daysOutsideMonth, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, isDisabled: isDisabled, isReadonly: isReadonly, isOpen: isOpen, label: label, onClose: dropdownCloseHandler, onCommit: datePickerCommitHandler, max: max, messages: messages, min: min, monthAndYearPicker: monthAndYearPicker, testId: testId ? testId + '_datePicker' : undefined, todayTimeZone: todayTimeZone, todayButton: todayButton, userAssistanceDensity: userAssistanceDensity, value: completeDateValue, weekDisplay: weekDisplay }))] }));
});
