 ...
 */
const RichCheckboxSet = forwardRef(({ children, onCommit, value, ...otherProps }, ref) => {
    const baseId = useId();
    ...
    return (jsx(CheckboxSetContext.Provider, { value: checkboxSetContext, children: jsx(BaseRichSelection, { ...otherProps, baseId: baseId, ref: ref, selection: "multiple", value: value, children: children }) }));
});
