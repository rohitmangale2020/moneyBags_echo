...
import { D as DATATIP_OFFSET } from './datatipUtils-0a36125e.js';
import { c as calculateOffset, g as getRandomId } from './layoutUtils-ec5be703.js';
...
import { r as rectangleWithBorderRadius } from './lineUtils-87255164.js';
import { u as useCssVars } from './useCssVars-bc2527ac.js';
import { u as useTextDimensions } from './useTextDimensions-45f79df4.js';
import { t as typographyVars, b as baseVars } from './themeContract.css-1ffed3bf.js';
...
function GanttRowLabelContainer({ rowObj, rowData, isRowSelected, isFocused, isHorizontalGridlinesVisible, ariaActive, children }) {
    ...
    return (jsx("div", { id: ariaActive?.dataId === rowObj.id ? ariaActive.ariaId : undefined, "data-oj-private-row-index": rowObj.index, role: "row", "aria-label": ariaLabel, class: classNames([
...
function useDatatip({ content, placement = 'top-end-corner', offset, borderColor, anchor, targetFocusRef, defaultContainer = 'enabled' }) {
    ...
    const datatipContent = content != null && content != '' ? (jsx(Layer, { children: jsx(Floating, { anchorRef: anchorRef, placement: placement, offsetValue: offsetValue, flipOptions: { crossAxis: true, mainAxis: true }, shiftOptions: { crossAxis: false, mainAxis: false }, children: jsx("div", { id: uniqueIdRef.current, className: classNames([
                    styles$2.visDatatipStyle,
                    defaultContainer === 'enabled' ? styles$2.borderEnabled : undefined
