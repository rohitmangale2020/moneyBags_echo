...
const StickyPositioningDropdown = ({ children, isOpen, onPosition, ...rest }) => {
    ...
    return (jsx(Dropdown, { isOpen: isOpen, onPosition: handlePosition, placement: placement, shiftOptions: DEFAULT_SHIFT_OPTIONS, ...rest, children: children }));
};
...
//# sourceMappingURL=SectionedContent-a39cd82d.js.map
