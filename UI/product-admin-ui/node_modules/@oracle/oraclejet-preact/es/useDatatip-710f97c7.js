 ...
 */
function useDatatip({ content, placement = 'top-end-corner', offset, borderColor, defaultContainer = 'enabled', anchor, touchResponse, isDisabled }) {
    ...
    const datatipContent = isVisible && !!content && !isDisabled ? (jsx(Layer, { children: jsx(Floating, { anchorRef: anchorRef, placement: placement, offsetValue: offsetValue, flipOptions: {
                crossAxis: anchor === 'pointer' ? true : false,
                mainAxis: anchor === 'pointer' ? true : false
            }, shiftOptions: { crossAxis: true, mainAxis: true }, children: jsx("div", { role: "tooltip", id: uniqueIdRef.current, className: classNames([
                    styles.visDatatipStyle,
                    defaultContainer === 'enabled' ? styles.borderEnabled : undefined
                ]), style: defaultContainer === 'enabled' ? { borderColor } : undefined, onPointerEnter: onContentPointerEnter, onPointerLeave: onHoverLeave, children: content }) }) })) : null;
    return {
        datatipContent,
        datatipProps: {
...
//# sourceMappingURL=useDatatip-710f97c7.js.map
