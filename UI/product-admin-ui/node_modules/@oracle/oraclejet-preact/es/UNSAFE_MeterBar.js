...
import { u as usePointerEvents, a as useMeterDatatip } from './useMeterDatatip-b8148b11.js';
import { u as useKeyboardEvents } from './useKeyboardEvents-9aae7ea3.js';
import { v as validateRange, g as getMeterAriaProps, b as getTrackAndIndicatorColor, h as hasLabelledReferenceLine, c as getMaxRefLabelDims, d as getDefaultReferenceLineLabelFontSize } from './meterUtils-19c07f4c.js';
...
import { g as getVisThresholdColor } from './utils-f4b2e9db.js';
...
import { t as typographyVars } from './themeContract.css-1ffed3bf.js';
...
function MeterBarWithDimensions({ max = 100, min = 0, value = 0, step = 1, length = '100%', width, height, size, orientation = 'horizontal', isTrackRendered = true, thresholdDisplay = 'all', indicatorSize = 1, testId, baseline, isReadonly, ...props }) {
    ...
    validateRange(min, max, value, step, false, isReadonly, baseline);
