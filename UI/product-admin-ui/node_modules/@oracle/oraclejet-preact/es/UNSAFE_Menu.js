...
import { S as SelectMenuGroupContext } from './SelectMenuGroupContext-6ee1b1e1.js';
export { M as Menu, a as MenuItem } from './SelectMenuGroupContext-6ee1b1e1.js';
export { b as SelectMenuItem, a as SelectSingleMenuGroup, S as Submenu } from './Submenu-d5927a83.js';
...
function SelectMultipleMenuGroup({ value, onCommit, children, groupKey }) {
    return (jsx(SelectMenuGroupContext.Provider, { value: { isMultiple: true, value, onCommit, groupKey }, children: children }));
}
...
export { MenuSeparator, SelectMultipleMenuGroup };
