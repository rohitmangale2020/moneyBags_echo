...
import { g as getActiveElement, e as focusOnElementOrNearestAncestor, f as focusWithin, b as focusOn, d as getAutofocusFocusables } from './tabbableUtils-c8311ec6.js';
import { n as normalizePosition } from './positionUtils-f26caad9.js';
import { g as getClientHints } from './clientHints-a42b510c.js';
import { u as useOutsideClick } from './useOutsideClick-f00c65fc.js';
...
const DrawerPopup = forwardRef(({ children, isOpen = false, autoFocusRef, placement = 'start', modality = 'modal', onClose, onTransitionEnd, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, 'aria-describedby': ariaDescribedBy, testId, ...props }, ref) => {
    ...
    if (isMounted) {
        ...
        if (modality === 'modal') {
            return (jsx(LogicalParentRefContext.Provider, { value: launcherRef, children: jsx(Modal, { isOpen: isMounted, children: renderDrawer() }) }));
        }
        else {
            return jsx(Layer, { logicalParentRef: launcherRef, children: renderDrawer() });
        }
    }
    return null;
});
