...
import { C as ComponentMessageContainer } from './ComponentMessageContainer-b3f70763.js';
...
function InlineUserAssistance({ assistiveText, fieldLabel, helpSourceLink, helpSourceText, id, isRequiredShown, requiredAlignment, messages = [], showInlineAssistanceOn = 'focus', userAssistanceDensity, testId }) {
    ...
    const uaInlineContent = messages.length > 0 ? (jsx(ComponentMessageContainer, { fieldLabel: fieldLabel, messages: messages })) : (assistiveText || helpSourceLink) && (showInlineAssistanceOn === 'always' || isFocused) ? (jsx(InlineHelp, { assistiveText: assistiveText, sourceLink: helpSourceLink, sourceText: helpSourceText })) : isRequiredShown ? (jsx(InlineRequired, { align: requiredAlignment })) : null;
...
//# sourceMappingURL=InlineUserAssistance-6aa2141e.js.map
