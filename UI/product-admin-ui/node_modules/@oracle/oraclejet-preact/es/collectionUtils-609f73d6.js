...
import { i as isKeyDefined, c as containsKey } from './keys-49c92dbb.js';
...
const getViewportConfig = (rootRef, config) => {
    return config ?? { scrollerRef: rootRef };
};
/**
...
// returns a ListItemContext based on ItemContext (added metadata and selector)
// note the type for ItemContext, this is the context coming from Collection
const getItemContext = (context, selectedKeys, isMultipleSelection, handleSelectionChange) => {
    const dataStateData = context.data;
    const selectorRenderer = isMultipleSelection
    ...
    return {
        ...
        isSelected: containsKey(selectedKeys, dataStateData.metadata.key)
    };
};

export { getKey as a, getFirstVisibleKey as b, getItemKeysArray as c, getPrevNextKeyUsingRef as d, getItemContext as e, findElementByKey as f, getElementContainsFunc as g, dragToScroll as h, handleSelectionRange as i, getViewportConfig as j, keyExtractor as k, getPrevNextKeyByCount as l, compareListItemContext as m, getPrevNextKey as n, handleEnterActionableMode as o, handleWrapActionableFocus as p, isMobile as q };
//# sourceMappingURL=collectionUtils-609f73d6.js.map
