...
import { C as CalendarUtils } from './getFormatParse-0b8d78e0.js';
import './logger-35b2acf7.js';
import { c as checkIsValidIsoYear, b as checkNoCalendarExtension } from './calendarDateUtils-a6baf09c.js';
 ...
 * @ignore
 */
// The ^ an $ anchors ensure that the entire string is matched.
// The \d+ pattern ensures that the string consists entirely of digits.
// Previously the regexp was /\d/ . This tests that there is at least one match of the regular expression
//  in the string. This would return true for 'F10', and we do not want that.
...
const stringToNumber = (s) => {
    const num = +s;
    if (isNaN(num)) {
        throw new Error(`Cannot convert the string ${s} to a number`);
    }
    return num;
};
...
export { getTodayAsCalendarDate as a, calendarDatesAreDifferent as c, getMonthName as g, isNumberOnlyString as i, numberToString as n, stringToNumber as s, translateCustomMasks as t, withinRange as w };
//# sourceMappingURL=maskUtils-b16a22c0.js.map
