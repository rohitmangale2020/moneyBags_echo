 ...
 */
const StyledDatePickerButton = forwardRef(({ isActivable = false, isReadonly = false, isAdjacentMonth = false, isDimmed = false, isForcedFocusRing = false, isHidden = false, isHoverable = false, isRestricted = false, isSelected = false, isToday = false, tabIndex, label, variant, ...props }, ref = null) => {
    ...
    const variantClasses = multiVariantStyles({
        ...
        focusRing: isForcedFocusRing ? 'forced' : 'notForced',
        variant
    });
...
//# sourceMappingURL=StyledDatePickerButton-a7782821.js.map
