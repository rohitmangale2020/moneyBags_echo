...
import { g as getDaysInMonth$1, i as isDateOnlyIsoString, a as getFormatParse } from './getFormatParse-0b8d78e0.js';
...
// Uses new Date(Date.UTC(year, month-1, day)) so it is timezone agnostic.
// Used when calculating the month view's week number.
const toJSDateUTC = (year, month, day) => {
    // Date uses 0-based index for month.
...
const getDatePlaceholdersFromPattern = (pattern) => {
    ...
    // JET-77359 WHEN A USER CHANGES THEIR TERRITORY IN USER PREFERENCES, THE OJ-C-INPUT-DATE-PICKER COMPONENT THROWS AN ERROR
    // When using patterns like `yyyy.MM.dd.`, we end up with an extra trailing literal which results in the
    // failure of the masks validation. So, remove any excessive literals from the placeholders here before
    // returning the result.
    const datePlaceholders = removeExcessiveLiteralsFromPlaceholders(convertMaskArrayToDatePlaceholders(arr));
...
export { formatCalendarMonthRequiredAsExample as A, formatIsoDateStrAsExample as B, getCalendarDateFromIso as C, getFormattedYearMonthDay as D, getDatePlaceholdersFromPattern as E, getMonthYearPlaceholdersFromDatePlaceholders as F, isCalendarDateAfter as G, isCompleteCalendarMonth as H, isValidCalendarMonthRequired as I, removeExcessiveLiteralsFromPlaceholders as J, toIsoCalendarDate as K, MIN_ISO_YEAR as M, getNumericFormattedYear as a, checkNoCalendarExtension as b, checkIsValidIsoYear as c, getIsoDateStr as d, toJSDateUTC as e, formatFullCalendarDate as f, getLongFormattedYearMonth as g, getClosestDecade as h, isDateOutOfRange as i, compareDates as j, addToCalendarDate as k, addToYear as l, addToMonth as m, getDaysInMonth as n, isCalendarDateBefore as o, getCalendarDateToday as p, constrainCalendarDate as q, getMonthsInYear as r, MAX_ISO_YEAR as s, toJSDate as t, MIN_ISO_MONTH as u, MIN_ISO_DAY as v, getDatePlaceholderMasks as w, formatShortCalendarDate as x, isCompleteCalendarDate as y, formatCalendarDateAsString as z };
//# sourceMappingURL=calendarDateUtils-a6baf09c.js.map
