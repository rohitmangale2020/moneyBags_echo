...
function DefaultList({ 'aria-label': ariaLabel, componentName, currentItemVariant, currentKey, data, itemRenderer, itemText, onCurrentKeyChange, onItemAction, onLoadRange = noOp, onSelectionChange, searchText, selectedKeys, selectionMode }) {
    const listItemRenderer = useCallback((listItemContext) => {
        ...
        return itemRenderer ? (itemRenderer(itemRendererProps)) : (jsxs(Flex, { align: "center", children: [listItemContext.selector && (jsx("div", { class: dropdownStyles.selectorWrapper, children: listItemContext.selector() })), jsx("div", { class: selectionMode === 'single'
                        ...
                        : dropdownStyles.multiSelectItem, children: jsx(ListItemText, { variant: "primary", children: jsx(HighlightText, { matchText: searchText, children: renderItemText(itemContext, itemText, componentName) }) }) })] }));
    }, [
        componentName,
        itemRenderer,
        itemText,
    ...
    return (jsx(List, { "aria-label": ariaLabel, allowTabbableMode: false, currentItemVariant: currentItemVariant, currentItemOverride: currentItemOverride, data: data ?? null, onPersistCurrentItem: onCurrentKeyChange, onItemAction: handleItemAction, onLoadRange: onLoadRange, onSelectionChange: handleSelectionChange, role: "listbox", selectedKeys: keys, selectionMode: selectionMode, children: (context) => listItemRenderer(context) }));
}
...
function EmptyResults() {
    ...
    // the input
    return (jsx("div", { class: dropdownStyles.results.extraItem, onMouseDown: preventDefaultForCurrentTarget, children: jsx(Text, { variant: "primary", children: translations.select_noMatchesFound() }) }));
}
...
function shouldIgnoreSelectInputKeyDownDuringComposition(event) {
    const isEnter = event.code === KEYS.ENTER || event.code === KEYS.NUMPAD_ENTER;
    const isArrow = event.code === KEYS.UP || event.code === KEYS.DOWN;
    // JET-77501 - WHILE TYPING /SEARCHING JAPANESE CHARACTERS THE MENU DID NOT SHOW THE SUGGESTIONS FOR THE ENTERED VALUE
...
function shouldIgnoreSelectInputKeyUpDuringComposition(event) {
    return event.isComposing && (event.code === KEYS.UP || event.code === KEYS.DOWN);
}
/**
...
export { DefaultList as D, EmptyResults as E, DropdownArrow as a, DropdownList as b, preventDefaultForCurrentTarget as c, useSelectCommon as d, isMobile as e, isPhone as f, isTablet as g, isBeforeDataFetch as h, isSimpleClick as i, isSearchTextEmptyOrUndefined as j, isSearchClearedFirstTime as k, shouldIgnoreSelectInputKeyUpDuringComposition as l, createKeysFromValueItems as m, preventDefault as p, renderItemText as r, shouldIgnoreSelectInputKeyDownDuringComposition as s, useCollectionRenderer as u };
//# sourceMappingURL=useSelectCommon-34b231da.js.map
