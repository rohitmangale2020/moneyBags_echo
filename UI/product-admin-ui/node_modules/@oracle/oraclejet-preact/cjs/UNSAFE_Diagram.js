...
var BaseDiagram = require('./BaseDiagram-d2ab5135.js');
...
require('./PRIVATE_BaseDiagram/themes/DiagramStyles.css.js');
...
function Diagram(props) {
    ...
    const { selectedIds, highlightedIds, onSelectionChange, onItemFocus, onItemHover, nodeRenderer, ...rest // all other props
     } = props;
    ...
    const mappedOnItemFocus = onItemFocus
        ...
        : undefined;
    const baseDiagramNodeRenderer = (ctx) => nodeRenderer({
        data: ctx.data,
        state: ctx.state
        // expander is ignored by flat nodeRenderer
    });
    return (jsxRuntime.jsx(BaseDiagram.BaseDiagram, { ...rest, selectedIds: mappedSelectedIds, highlightedIds: mappedHighlightedIds, onSelectionChange: mappedOnSelectionChange, onItemFocus: mappedOnItemFocus, onItemHover: mappedOnItemHover, nodeRenderer: baseDiagramNodeRenderer, normalizeLinks: true }));
}
