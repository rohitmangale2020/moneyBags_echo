...
var Table = require('./Table-2d3b461b.js');
...
require('./PRIVATE_TableCommon/themes/Common.css.js');
...
require('./UNSAFE_Dialog/themes/redwood/DialogTheme.js');
...
require('./useDraggable-aa4ac3a2.js');
require('./IconButton-d753d39b.js');
require('./Close-86edffef.js');
require('./Resizable-13b918de.js');
require('./PRIVATE_Resizable/themes/ResizableStyles.css.js');
...
require('./Submenu-ac9a8ba3.js');
require('./DirectionalExpandArrowIcon-12c12335.js');
require('./CaretLeft-a10ae545.js');
require('./withDirectionIcon-a14b071b.js');
require('./DirectionalCollapseArrowIcon-f773f282.js');
require('./UNSAFE_Separator/themes/SeparatorStyles.css.js');



require('./UNSAFE_Menu/themes/redwood/MenuSeparatorVariants.css.js');
require('./NumberInputText-64705c3a.js');
...
require('./PrefixSuffix-5fea6fc0.js');
require('./UNSAFE_PrefixSuffix/themes/PrefixSuffixStyles.css.js');

require('./usePrefixSuffix-a6a1b772.js');
...
require('./InlineUserAssistance-ca15d165.js');
...
require('./ChevronUp-3c1b500f.js');
require('./Minus-fb6a3ff8.js');
require('./Plus-2b1b949c.js');
require('./Grid-156807d4.js');
require('./grid-7c06084e.js');

require('./useSpinning-929c5225.js');
require('./useSelectableTextField-892b62db.js');
require('./EventUtils-c416c5e1.js');
...
require('./useSortableContext-0510fd8e.js');
require('./SelectorAll-d0da0a6d.js');
require('./SortControl-7b66435a.js');
 ...
 */
const TableView = compat.forwardRef(({ 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, 'aria-describedby': ariaDescribedBy, getAccessibleRowHeaders, children, columns, columnOrder, columnWidths, contextMenuConfig, viewportConfig, layout = 'contents', data, getRowKey, hasMore = false, onLoadMore, currentCellOverride, onPersistCurrentCell, currentRowVariant, gridlines = { horizontal: 'visible', vertical: 'hidden' }, selectionMode = { row: 'none', column: 'none' }, selected, onSelectionChange, onRowAction, sortCriterion = [], onSortCriterionChange, horizontalScrollPositionOverride, verticalScrollPositionOverride, columnResizingIndicator, onColumnResizing, onColumnResize, noDataRenderer, scrollerRef, testId, ...dimensions }, ref) => {
    const { ...mergedStyles } = mergedInterpolations(dimensions);
    const isExternalScroller = viewportConfig != null;
    const classArray = [UNSAFE_TableView_themes_TableViewStyles_css.tableViewStyles.base];
    classArray.push(isExternalScroller ? UNSAFE_TableView_themes_TableViewStyles_css.tableViewStyles.externalScroller : UNSAFE_TableView_themes_TableViewStyles_css.tableViewStyles.internalScroller);
    const tableViewClasses = classNames.classNames(classArray);
    return (jsxRuntime.jsx("div", { class: tableViewClasses, style: mergedStyles, children: jsxRuntime.jsx(Table.Table, { "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy, getAccessibleRowHeaders: getAccessibleRowHeaders, children: children, columns: columns, columnOrder: columnOrder, columnWidths: columnWidths, contextMenuConfig: contextMenuConfig, viewportConfig: viewportConfig, layout: layout, data: data, getRowKey: getRowKey, hasMore: hasMore, onLoadMore: onLoadMore, currentCellOverride: currentCellOverride, onPersistCurrentCell: onPersistCurrentCell, currentRowVariant: currentRowVariant, gridlines: gridlines, selectionMode: selectionMode, selected: selected, onSelectionChange: onSelectionChange, onRowAction: onRowAction, horizontalScrollPositionOverride: horizontalScrollPositionOverride, verticalScrollPositionOverride: verticalScrollPositionOverride, sortCriterion: sortCriterion, onSortCriterionChange: onSortCriterionChange, columnResizingIndicator: columnResizingIndicator, onColumnResizing: onColumnResizing, onColumnResize: onColumnResize, noDataRenderer: noDataRenderer, scrollerRef: scrollerRef, testId: testId, ref: ref }) }));
});
