...
const DrawerPopup = compat.forwardRef(({ children, isOpen = false, autoFocusRef, placement = 'start', modality = 'modal', onClose, onTransitionEnd, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, 'aria-describedby': ariaDescribedBy, testId, ...props }, ref) => {
    ...
    if (isMounted) {
        ...
        if (modality === 'modal') {
            return (jsxRuntime.jsx(Modal.LogicalParentRefContext.Provider, { value: launcherRef, children: jsxRuntime.jsx(Modal.Modal, { isOpen: isMounted, children: renderDrawer() }) }));
        }
        else {
            return jsxRuntime.jsx(Layer.Layer, { logicalParentRef: launcherRef, children: renderDrawer() });
        }
    }
    return null;
});
