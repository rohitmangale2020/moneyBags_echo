...
var useTabbableModeSet = require('./useTabbableModeSet-930b0b3e.js');
var useSwatchSelection = require('./useSwatchSelection-8ca16859.js');
...
const BaseSwatchViewImpl = compat.forwardRef(({ children, data, onLoadMore = () => { }, hasMore = false, getRowKey, currentKey, onCurrentKeyChange, selectedKeys = emptyKeys, onSelectionChange, viewportConfig, focusBehavior = 'swatch', 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, columns, swatchSize, updateSwatchSize }, ref) => {
    ...
    /*****************************************************************************************/
    const { currentKeyProps } = useCurrentKey.useCurrentKey((element) => collectionUtils.keyExtractor(element, ITEM_SELECTOR), true, isCurrentTabbableKey(currentKey), 
...
//# sourceMappingURL=BaseSwatchView-5fafa065.js.map
