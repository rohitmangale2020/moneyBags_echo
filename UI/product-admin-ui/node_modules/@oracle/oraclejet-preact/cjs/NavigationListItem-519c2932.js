...
var TabBarContextMenu = require('./TabBarContextMenu-9a34609f.js');
...
function useNavigationList({ containerRef, selection, onRemove, onSelectionChange, children, contextMenuConfig }) {
    ...
    const { currentKeyProps } = useCurrentKey.useCurrentKey((element) => onRemove
        ...
        : collectionUtils.keyExtractor(element, ITEM_SELECTOR), false, false, collectionUtils.getPrevNextKeyUsingRef(containerRef, currentKey, true, ITEM_SELECTOR), collectionUtils.getPrevNextKeyUsingRef(containerRef, currentKey, false, ITEM_SELECTOR), undefined, undefined, currentKey, onCurrentKeyChange);
...
const NavigationList = compat.forwardRef(({ children, selection, edge = 'start', onSelectionChange, onRemove, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelLedBy, testId, display = 'standard' }, ref) => {
...
//# sourceMappingURL=NavigationListItem-519c2932.js.map
