...
var useTooltipControlled = require('./useTooltipControlled-11ad62b6.js');
var safeHref = require('./safeHref-c478be73.js');
...
function BaseNavigationListItem({ itemKey, label, badge, metadata, severity = 'none', removeIcon, icon, href, 'aria-controls': ariaControls }) {
    ...
    const navlistLinkItemRenderer = () => {
        const safeHref$1 = safeHref.getSafeHref(href, 'NavigationList');
        return (jsxRuntime.jsx("div", { ...itemHandlers, class: itemClasses, children: jsxRuntime.jsx("a", { tabindex: -1, role: "tab", "data-oj-key": itemKey, id: itemId, class: navigationItemLinkClass, "aria-selected": isSelected, "aria-controls": ariaControls, href: safeHref$1, onClick: onClickLink, children: isComplexItem ? complexItemRenderer() : labelRenderer() }) }));
    };
...
//# sourceMappingURL=NavigationListLinkItem-dc8c5e87.js.map
