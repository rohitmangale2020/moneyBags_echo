...
var Submenu = require('./Submenu-ac9a8ba3.js');
var jsxRuntime = require('preact/jsx-runtime');
var useComponentTheme = require('./useComponentTheme-181c58a1.js');
var Separator = require('./Separator-85962472.js');
var UNSAFE_Menu_themes_redwood_MenuSeparatorTheme = require('./UNSAFE_Menu/themes/redwood/MenuSeparatorTheme.js');
...
require('./UNSAFE_Menu/themes/MenuSeparatorStyles.css.js');

require('./UNSAFE_Menu/themes/redwood/MenuSeparatorBaseTheme.css.js');

require('./UNSAFE_Menu/themes/redwood/MenuSeparatorVariants.css.js');

function SelectMultipleMenuGroup({ value, onCommit, children, groupKey }) {
    return (jsxRuntime.jsx(SelectMenuGroupContext.SelectMenuGroupContext.Provider, { value: { isMultiple: true, value, onCommit, groupKey }, children: children }));
}

function MenuSeparator() {
    const { classes } = useComponentTheme.useComponentTheme(UNSAFE_Menu_themes_redwood_MenuSeparatorTheme.MenuSeparatorRedwoodTheme);
    return (jsxRuntime.jsx("div", { class: classes, children: jsxRuntime.jsx(Separator.Separator, {}) }));
}

exports.Menu = SelectMenuGroupContext.Menu;
exports.MenuItem = SelectMenuGroupContext.MenuItem;
exports.SelectMenuItem = Submenu.SelectMenuItem;
exports.SelectSingleMenuGroup = Submenu.SelectSingleMenuGroup;
