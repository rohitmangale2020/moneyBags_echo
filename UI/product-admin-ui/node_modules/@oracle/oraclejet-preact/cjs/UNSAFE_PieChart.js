...
var utils$1 = require('./utils-ee4fc356.js');
var classNames = require('./classNames-c14c6ef3.js');
var usePieChartNav = require('./usePieChartNav-0aef2f9b.js');
...
function PieChartWithDimensions({ width, height, testId, innerRadius = 0, contextMenuConfig, drilling = 'off', selectionMode = 'none', onItemDrill, onItemHover, onItemFocus, ...props }) {
    ...
    let data = props.data.filter(item => item.value > 0);
    if (isRtl) {
    ...
    const { content: datatipString, borderColor, defaultContainer } = activeData && props.datatip
    ...
    return (jsxRuntime.jsxs("div", { ref: rootRef, tabIndex: 0, "aria-label": props['aria-label'], "aria-labelledby": props['aria-labelledby'], "aria-activedescendant": activeId, role: "application", ...mergedProps, ...testIdProps, className: UNSAFE_PieChart_themes_PieChartStyles_css.styles.chart, style: touchResponseStyle, children: [renderedSlices.length > 0 && hasData && ( //className={styles.svg}
            jsxRuntime.jsxs("svg", { className: UNSAFE_PieChart_themes_PieChartStyles_css.styles.svg, children: [renderedSlices.map((item, index) => {
...
function PieChart({ width, height, ...props }) {
    return (jsxRuntime.jsx(TrackResizeContainer.TrackResizeContainer, { width: width, height: height, class: UNSAFE_PieChart_themes_PieChartStyles_css.dimensionStyle, children: (w, h) => (jsxRuntime.jsx(PieChartWithDimensions, { width: w, height: h, ...props })) }));
}
