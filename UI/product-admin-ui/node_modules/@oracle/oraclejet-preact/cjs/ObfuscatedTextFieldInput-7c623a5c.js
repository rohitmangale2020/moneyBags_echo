...
const ObfuscatedTextFieldInput = ({ character = '•', currentCommitValue, inputRef, isRevealed = false, onCommit, onInput, type = 'text', value, ...passThroughProps }) => {
    ...
    const onKeyDownHandler = compat.useCallback((event) => {
        ...
        // using keydown event.
        const _isUndoEvent = keyboardUtils.isUndoEvent(event);
        const _isRedoEvent = keyboardUtils.isRedoEvent(event);
    ...
    return (jsxRuntime.jsx("div", { class: UNSAFE_TextField_themes_ObfuscatedTextFieldInputStyles_css.containerStyles, 
        ...
        onContextMenu: selectAllWhenObfuscated, children: jsxRuntime.jsx(StyledTextField.TextFieldInput, { ...passThroughProps, 
            // override properties
...
//# sourceMappingURL=ObfuscatedTextFieldInput-7c623a5c.js.map
