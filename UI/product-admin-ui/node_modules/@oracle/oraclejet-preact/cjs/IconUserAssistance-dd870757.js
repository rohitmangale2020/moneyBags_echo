...
var Help = require('./Help-f234ad08.js');
var Popup = require('./Popup-da1d83bc.js');
...
var InlineHelp = require('./InlineHelp-0bbda3d9.js');

/**
 * Created to match icon user assistance spec for use with radio option, pending design review
 * of inline UA assistance.
 */
const IconUserAssistance = ({ assistiveText, helpSourceLink, helpSourceText, isTabbable = true, id, variant = 'checkbox' }) => {
    ...
    const helpForCheckboxString = translations.checkbox_helpForCheckbox();
    ...
    const onClickHandler = hooks.useCallback((e) => {
        e.preventDefault();
        toggle();
    }, [toggle]);
    ...
    const iconUserAssistanceClasses = classNames.classNames([popupBaseTheme, UNSAFE_UserAssistance_themes_UserAssistanceStyles_css.iconUserAssistancePopup]);
    return helpSourceLink || assistiveText ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("span", { onKeyDown: handleOnKeyDown, onClick: onClickHandler, role: "button", "aria-labelledby": helpStringId, "aria-haspopup": "dialog", ref: anchorRef, tabIndex: isTabbable ? 0 : -1, class: UNSAFE_UserAssistance_themes_UserAssistanceStyles_css.iconUserAssistanceIcon, id: `${id}-help-icon`, children: jsxRuntime.jsx(Help.SvgHelp, {}) }), jsxRuntime.jsx(HiddenAccessible.HiddenAccessible, { id: helpStringId, isHidden: true, children: variant === 'checkbox' ? helpForCheckboxString : helpForRadioString }), jsxRuntime.jsx(Popup.Popup, { placement: "top", isOpen: isOpen, anchorRef: anchorRef, onClose: setIsOpenFalse, onClickOutside: handleOutsideClick, shiftOptions: { mainAxis: true, crossAxis: false }, maxWidth: "296px", children: jsxRuntime.jsx("div", { id: id, tabIndex: 0, class: iconUserAssistanceClasses, onMouseUp: handleLinkEvent, onKeyDown: handleLinkEvent, children: jsxRuntime.jsx(InlineHelp.InlineHelp, { assistiveText: assistiveText, sourceLink: helpSourceLink, sourceText: sourceText }) }) })] })) : null;
};

exports.IconUserAssistance = IconUserAssistance;
//# sourceMappingURL=IconUserAssistance-dd870757.js.map
