...
var DragV = require('./DragV-9a45dd0c.js');
...
function DragHandle({ testId }) {
    ...
    return (jsxRuntime.jsx("div", { ...mergeProps.mergeProps(activeProps, testIdProps), "data-oj-draggable": "", draggable: true, class: classes, role: "presentation", children: jsxRuntime.jsx(DragV.SvgDragV, {}) }));
}
