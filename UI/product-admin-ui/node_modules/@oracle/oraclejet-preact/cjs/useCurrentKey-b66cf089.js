 ...
 * @param isTabbable whether the component is currently in tabbable mode
 ...
 * @returns
 */
function useCurrentKey(keyExtractor, allowShiftKey, isTabbable, getVerticalPrevKey, getVerticalNextKey, getHorizontalPrevKey, getHorizontalNextKey, currentKey, onChange, keyComparator) {
    ...
    const onKeyDown = hooks.useCallback((event) => {
        if (onChange && keys.isKeyDefined(currentKey && !isTabbable)) {
...
//# sourceMappingURL=useCurrentKey-b66cf089.js.map
