...
const isPointOutside = (event, ref) => {
    ...
    return ref.every((elRef) => !elRef.current?.contains(target) && !popupUtils.isLogicalAncestor(elRef.current, target));
};
...
//# sourceMappingURL=useOutsideMousedown-eda95637.js.map
