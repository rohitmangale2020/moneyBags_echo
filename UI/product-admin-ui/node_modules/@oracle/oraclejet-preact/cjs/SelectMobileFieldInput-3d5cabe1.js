...
var Link = require('./Link-7dc21242.js');
...
function Dropdown({ anchorRef, children, dropdownRef, id, isOpen, onAutoDismiss, onPosition }) {
    ...
    const inlineStyle = isOpen
        ...
        : {};
    return !isOpen ? null : (jsxRuntime.jsx(Layer.Layer, { logicalParentRef: anchorRef, children: jsxRuntime.jsx(Floating.Floating, { anchorRef: anchorRef, sizeOptions: DROPDOWN_SIZE_OPTIONS, shiftOptions: DROPDOWN_SHIFT_OPTIONS, ref: dropdownRef, placement: placement, offsetValue: DROPDOWN_OFFSET, onPosition: handlePosition, children: jsxRuntime.jsx("div", { class: PRIVATE_SelectCommon_themes_dropdownStyles_css.dropdownStyles.base, id: id, style: inlineStyle, onKeyDown: handleKeyDown, onMouseDown: useSelectCommon.preventDefaultForCurrentTarget, children: children }) }) }));
}
...
//# sourceMappingURL=SelectMobileFieldInput-3d5cabe1.js.map
