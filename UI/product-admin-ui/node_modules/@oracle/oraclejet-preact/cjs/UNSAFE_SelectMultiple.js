...
var SelectMobileFieldInput = require('./SelectMobileFieldInput-3d5cabe1.js');
var useSelectCommon = require('./useSelectCommon-73e8b3ab.js');
...
var View = require('./View-67ff7d0e.js');
var Button = require('./Button-59db38b3.js');
...
var useEffectEvent = require('./useEffectEvent-832ffba5.js');
var equals = require('./equals-098f7781.js');
var mergeProps = require('./mergeProps-e3da7237.js');
var stringUtils = require('./stringUtils-3e19c8af.js');
var useHiddenTestMethod = require('./useHiddenTestMethod-620e91e0.js');
...
require('./CompactLabelAssistance-2c47d82e.js');
require('./useTabbableMode-dbd254e8.js');
require('./Help-f234ad08.js');
...
require('./UNSAFE_TextField/themes/FormControlUtilsStyles.css.js');
...
require('./LabelValueLayout-05fda111.js');
require('./StyledLabelValueLayout-3ee66ef1.js');
...
require('./ErrorS-eecfc81d.js');
require('./InformationS-697bb689.js');
require('./WarningS-05e4f69d.js');
require('./PRIVATE_Message/themes/MessageStyles.css.js');
require('./soundUtils-0dd9f572.js');
...
require('./Link-7dc21242.js');
require('./usePressClick-7a34624a.js');
...
require('./HighlightText-93f2fea0.js');

require('./Grid-156807d4.js');
require('./grid-7c06084e.js');


require('./ListItemText-3e93c76c.js');
require('./List-71a2ac8b.js');
require('./keys-25710458.js');
require('./collectionUtils-64b041ac.js');
require('./Selector-b2ee1b41.js');
...
require('./useTheme-71e406b0.js');
require('./useSelection-0ef0ee3c.js');
require('./textSelectionUtils-57082239.js');
require('./useAdditiveSelection-bf845689.js');
require('./useItemAction-d84f8300.js');
require('./Inset-69f359cd.js');
require('./UNSAFE_Inset/themes/InsetStyles.css.js');


require('./usePress-886180e4.js');
require('./CaretDown-a62d0c7e.js');
...
require('./useActionable-0862ff50.js');
require('./UNSAFE_Chip/themes/ChipStyles.css.js');

require('./BaseButton-e31fec18.js');
require('./BareButton-e8a030d7.js');
require('./useBareButton-463210c9.js');
require('./buttonUtils-dff2ea3e.js');
require('./id-86356250.js');
require('./ButtonLabelLayout-c0018463.js');
require('./useButtonLabelLayoutTheme-e99dfa77.js');
...
function SelectMultipleDesktopDropdown({ assistiveText, collectionRenderer, collectionRendererContext, data, dropdownId, dropdownRef, helpSourceLink, helpSourceText, isAddToListShown, isDisabled, isDropdownAbove, isEmptyResults, isOpen, isReadonly, label, mainFieldRef, userAssistanceDensity, onAddToListAction, onAutoDismiss, onPosition }) {
    ...
    const dropdownInlineUserAssistance = isOpen &&
        ...
        (userAssistanceDensity === 'efficient' || userAssistanceDensity === 'reflow') ? (jsxRuntime.jsx(TabbableModeContext.TabbableModeContext.Provider, { value: { isTabbable: false }, children: jsxRuntime.jsx(SelectMobileFieldInput.DropdownUserAssistance, { assistiveText: assistiveText, fieldLabel: label, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, userAssistanceDensity: userAssistanceDensity }) })) : undefined;
    const dropdownListContent = isEmptyResults ? (isAddToListShown ? undefined : (jsxRuntime.jsx(useSelectCommon.EmptyResults, {}))) : (collectionRenderer(collectionRendererContext));
    const addToListContent = isAddToListShown ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [!isEmptyResults && (jsxRuntime.jsx("div", { onMouseDown: useSelectCommon.preventDefault, children: jsxRuntime.jsx(Separator.Separator, {}) })), jsxRuntime.jsx(SelectMobileFieldInput.LinkItem, { isHighlighted: isEmptyResults, onAction: onAddToListAction, children: translations.select_addToList() })] })) : undefined;
    return (jsxRuntime.jsxs(SelectMobileFieldInput.Dropdown, { dropdownRef: dropdownRef, id: dropdownId, isOpen: isOpen, anchorRef: mainFieldRef, onAutoDismiss: onAutoDismiss, onPosition: onPosition, children: [jsxRuntime.jsxs(useSelectCommon.DropdownList, { hasBottomGap: dropdownInlineUserAssistance === undefined, isLoading: data === null, children: [dropdownListContent, addToListContent] }), dropdownInlineUserAssistance] }));
}
...
function SelectMultipleField({ children, columnSpan, fieldLabel, hasInsideLabel, isBackButtonShown, isClearButtonShown, isDropdownArrowShown, isDropdownSelectedOnlyView, isSelectedValuesCountShown, selectedValuesCount, onBackButtonClick, onClearButtonClick, onDropdownArrowClick, onSelectedValuesCountKeyDown, onSelectedValuesCountKeyUp, onSelectedValuesCountMouseDown, onSelectedValuesCountToggle, ...passThroughTextFieldProps }) {
    ...
    const translations = useTranslationBundle.useTranslationBundle('@oracle/oraclejet-preact');
    const backButton = isBackButtonShown ? (jsxRuntime.jsx(IconButton.IconButton, { "aria-label": translations.selectMultiple_back(), size: "xs", variant: "ghost", onAction: onBackButtonClick, children: jsxRuntime.jsx(NavLeft.SvgNavLeft, {}) })) : null;
    const clearButton = isClearButtonShown ? (jsxRuntime.jsx(IconButton.IconButton, { "aria-label": translations.formControl_clear(), size: "sm", variant: "ghost", onAction: onClearButtonClick, children: jsxRuntime.jsx(NavLeft.SvgCancelS, {}) })) : null;
...
function TextTag({ children, removeIcon = 'never', isSelected = false, onRemoveAction, onSelect, onRemoveIconClick, isFocused, value }) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("span", { ref: spanRef, class: rootClasses, tabIndex: -1, onClick: onSelectCallback, onKeyUp: onKeyUp, 
                ...
                onMouseDown: useSelectCommon.preventDefault, role: "option", "aria-describedby": removeIcon === 'never' ? navigationTextId : undefined, "aria-selected": isSelected ? 'true' : 'false', children: [jsxRuntime.jsx(Text.Text, { size: "md", variant: "inherit", children: children }), removeIcon === 'always' && (jsxRuntime.jsx(TabbableModeContext.TabbableModeContext.Provider, { value: { isTabbable: false }, children: jsxRuntime.jsx(IconButton.IconButton, { size: "xs", variant: "ghost", onAction: onRemoveIconClickCallback, children: jsxRuntime.jsx(Close.SvgClose, {}) }) }))] }), 
            // We only want to show the remove selected tag instruction text when there is no remove icon.
            // When there is a remove icon, the screen reader will read the icon and the user
            // can press the icon to delete the tag.
            removeIcon === 'never' && (jsxRuntime.jsx(HiddenAccessible.HiddenAccessible, { id: navigationTextId, children: translations.selectMultiple_removeSelectedTagInstructionText() }))] }));
}
...
function createDisplayValues(itemText, selectedItems) {
    ...
    const mapFunc = (itemContext) => useSelectCommon.renderItemText(itemContext, itemText, 'SelectMultiple');
    const mappedArray = arValues.map(mapFunc);
    return new Set(mappedArray);
}
function createTextTags(itemText, selectedItems = []) {
    return selectedItems.map((item) => ({
        label: useSelectCommon.renderItemText(item, itemText, 'SelectMultiple') ?? '',
        value: item.key
    }));
}
...
function useMobileDropdown({ data, inputRef, isDropdownOpen, isDropdownSelectedOnlyView, itemText, textTagListRef, userInput, valueItems, onCommit, setDropdownOpen, setUserInput, stopFiltering }) {
    const [currentRow, setCurrentRow] = hooks.useState({
        rowKey: undefined
    });
    const [dropdownSelectedKeys, setDropdownSelectedKeys] = hooks.useState(useSelectCommon.createKeysFromValueItems(valueItems));
    ...
    const { data: selectedOnlyData } = useSelectedOnlyData({
    ...
    const onSelectedKeysChange = hooks.useCallback((detail) => {
    ...
    const closeDropdown = hooks.useCallback(() => {
        ...
        setDropdownSelectedKeys(useSelectCommon.createKeysFromValueItems(valueItems));
    ...
    const onApply = hooks.useCallback(() => {
        ...
        onCommit({
            previousValue: useSelectCommon.createKeysFromValueItems(valueItems),
    ...
    if (prevValueItems !== valueItems) {
        ...
        if (!isDropdownOpen) {
            setDropdownSelectedKeys((prevDropdownSelectedKeys) => {
                const nextDropdownSelectedKeys = useSelectCommon.createKeysFromValueItems(valueItems);
    ...
    const collectionRendererContext = useSelectCommon.useCollectionRenderer({
    ...
    return {
        ...
        selectMultipleFieldProps: {
            ...
            isDropdownSelectedOnlyView: isInternalSelectedOnlyView,
            isSelectedValuesCountShown: (dropdownSelectedKeys?.size ?? 0) > 0 || isInternalSelectedOnlyView,
...
function SelectMultipleMobileDropdown({ 'aria-describedby': ariaDescribedBy, 'aria-label': ariaLabel, assistiveText, collectionRenderer, data, dropdownId, enabledElementRef, helpSourceLink, helpSourceText, isAddToListShown, isDisabled, isEmptyResults, isFocused, isLoading, isOpen, isReadonly, isRequired, isSelectedOnlyView: propIsSelectedOnlyView, itemText, label, liveRegionText, placeholder, propIsLoading, selectedValuesDescriptionId, setDropdownOpen, setUserInput, stopFiltering, textAlign, textTagListRef, userAssistanceDensity, userInput, valueItems, virtualKeyboard, onAddToListAction, onCommit, onFieldBlur, onFieldFocus, onFieldInput, onFieldKeyDown, onFieldKeyUp }) {
    const translations = useTranslationBundle.useTranslationBundle('@oracle/oraclejet-preact');
    const { collectionRendererContext, footerProps: mobileDropdownFooterProps, selectMultipleFieldInputProps: mobileDropdownSelectMultipleFieldInputProps, selectMultipleFieldProps: mobileDropdownSelectMultipleFieldProps, selectedValuesCountProps: mobileDropdownSelectedValueCountProps } = useMobileDropdown({
        data,
 ...
 * state.
 */
function useSelectMultiple({ addToList, ariaDescribedBy, data: propData, inputRef, isDisabled, isFocused: propIsFocused, isReadonly, onAddToListAction, onCommit, onFilter, valueItems }) {
    ...
    const [prevValueItems, setPrevValueItems] = hooks.useState(valueItems);
    const [selectedKeys, setSelectedKeys] = hooks.useState(useSelectCommon.createKeysFromValueItems(valueItems));
    ...
    const isAddToListShown = addToList === 'on' && isUserFiltering && searchText != null && searchText.length > 0;
    ...
    const combinedAriaDescribedBy = stringUtils.l([
    ...
    const shouldSelectCurrentRow = hooks.useCallback((currentRowKey) => {
    ...
    const textFieldRef = hooks.useRef(null);
    ...
    useHiddenTestMethod.useHiddenTestMethod({
    ...
    // the correct value)
    if (prevValueItems !== valueItems) {
        const keys = useSelectCommon.createKeysFromValueItems(valueItems);
    ...
    const handleSelectedValuesCountMouseDown = hooks.useCallback((event) => {
        ...
        // is handled
        event.preventDefault();
        // explicitly focus the chip because it won't happen naturally due to preventDefault()
        chipRef.current?.focus();
    }, [chipRef]);
    ...
    const handleInputKeyDown = hooks.useCallback((event) => {
        // JET-77501 - WHILE TYPING /SEARCHING JAPANESE CHARACTERS THE MENU DID NOT SHOW THE SUGGESTIONS FOR THE ENTERED VALUE
        // During composition, keep Enter/Up/Down with the IME so SelectMultiple does not
        // commit a value, prevent IME navigation, or move focus into the dropdown.
        if (useSelectCommon.shouldIgnoreSelectInputKeyDownDuringComposition(event)) {
            return;
        }
        baseHandleMainFieldKeyDown(event);
        myHandleMainFieldKeyDown(event);
    }, [baseHandleMainFieldKeyDown, myHandleMainFieldKeyDown]);
    const handleInputKeyUp = hooks.useCallback((event) => {
        // JET-77501 - WHILE TYPING /SEARCHING JAPANESE CHARACTERS THE MENU DID NOT SHOW THE SUGGESTIONS FOR THE ENTERED VALUE
        // During composition, keep Up/Down with the IME so SelectMultiple does not open the
        // dropdown, move focus into it, or change the current row after IME candidate navigation.
        if (useSelectCommon.shouldIgnoreSelectInputKeyUpDuringComposition(event)) {
            return;
        }
        handleMainFieldKeyUp(event);
    ...
    }, [handleInput, handleInputKeyDown, handleInputKeyUp]);
 ...
 */
const SelectMultiple = compat.forwardRef(({ addToList = 'off', 'aria-describedby': propAriaDescribedBy, assistiveText, collectionRenderer, columnSpan, data: propData, helpSourceLink, helpSourceText, isDisabled: propIsDisabled, isLoading: propIsLoading, isReadonly: propIsReadonly, isRequired, isRequiredShown, itemRenderer, itemText, label, labelEdge: propLabelEdge, labelStartWidth: propLabelStartWidth, messages, onAddToListAction, onCommit, onFilter, onLoadRange, placeholder, testId, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, valueItems, variant = 'default', virtualKeyboard }, ref) => {
    ...
    const { focusProps, isFocused: origIsFocused, methods: focusMethods } = useFocusableTextField.useFocusableTextField({
        isDisabled,
        isReadonly,
        enabledElementRef,
        readonlyElementRef
    });
    compat.useImperativeHandle(ref, () => focusMethods, [focusMethods]);
    const { addToListEventHandlers, ariaProps, collectionRendererContext, data, dropdownArrowEventHandlers, dropdownEventHandlers, dropdownRef, hasSelectedValuesCount, inputEventHandlers, isAddToListShown, isDataFetched, isDropdownAbove, isDropdownOpen, isDropdownSelectedOnlyView, isEmptyResults, isFocused, isUserFiltering, mainFieldRef, mouseProps, selectedValuesCountProps, selectedValuesDescriptionId, selectedValuesKeyboardNavDescriptionId, setDropdownOpen, setUserInput, stopFiltering, textFieldRef, textTagListProps, userInput } = useSelectMultiple({
        addToList,
    ...
    const translations = useTranslationBundle.useTranslationBundle('@oracle/oraclejet-preact');
    const defaultCollectionRenderer = compat.useCallback(({ currentRowKeyOverride, onPersistCurrentRowKey, onSelectedChange, searchText, selected, selectedOnlyData }) => (jsxRuntime.jsx(useSelectCommon.DefaultList, { "aria-label": label ?? '', componentName: "SelectMultiple", currentItemVariant: "highlight", currentKey: currentRowKeyOverride, data: selectedOnlyData ?? propData, itemRenderer: itemRenderer, itemText: itemText, searchText: selectedOnlyData ? undefined : isUserFiltering ? searchText : undefined, selectedKeys: selected, selectionMode: "multiple", onCurrentKeyChange: onPersistCurrentRowKey, onLoadRange: selectedOnlyData ? undefined : onLoadRange, onSelectionChange: onSelectedChange })), [isUserFiltering, itemRenderer, itemText, label, onLoadRange, propData]);
    if (isReadonly) {
    ...
    const dropdown = !shouldShowDropdown ? null : useSelectCommon.isPhone() ? (jsxRuntime.jsx(SelectMultipleMobileDropdown, { "aria-describedby": ariaProps.ariaDescribedBy, "aria-label": ariaLabel, assistiveText: assistiveText, collectionRenderer: collectionRenderer ?? defaultCollectionRenderer, 
        ...
        data: propData, dropdownId: dropdownId, enabledElementRef: enabledElementRef, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, isAddToListShown: isAddToListShown, isDisabled: isDisabled, isEmptyResults: isEmptyResults, isFocused: isFocused, isLoading: isLoading, isOpen: shouldShowDropdown, isReadonly: isReadonly, isRequired: isRequired, isSelectedOnlyView: isDropdownSelectedOnlyView, itemText: itemText, label: label, liveRegionText: liveRegionText, placeholder: placeholder, propIsLoading: propIsLoading, selectedValuesDescriptionId: selectedValuesDescriptionId, setDropdownOpen: setDropdownOpen, setUserInput: setUserInput, stopFiltering: stopFiltering, textAlign: textAlign, textTagListRef: textTagListProps.textTagListRef, userAssistanceDensity: userAssistanceDensity, userInput: userInput, valueItems: valueItems, virtualKeyboard: virtualKeyboard, onAddToListAction: addToListEventHandlers.onAction, onCommit: onCommit, onFieldBlur: focusProps.onFocusOut, onFieldFocus: focusProps.onFocusIn, onFieldInput: inputEventHandlers.onInput, onFieldKeyDown: inputEventHandlers.onKeyDown, onFieldKeyUp: inputEventHandlers.onKeyUp })) : (jsxRuntime.jsx(SelectMultipleDesktopDropdown, { ...dropdownEventHandlers, assistiveText: assistiveText, collectionRenderer: collectionRenderer ?? defaultCollectionRenderer, collectionRendererContext: collectionRendererContext, dropdownId: dropdownId, dropdownRef: dropdownRef, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, isAddToListShown: isAddToListShown, isDisabled: isDisabled, isDropdownAbove: isDropdownAbove, isEmptyResults: isEmptyResults, isOpen: shouldShowDropdown, isReadonly: isReadonly, label: label, mainFieldRef: mainFieldRef, onAddToListAction: addToListEventHandlers.onAction, userAssistanceDensity: userAssistanceDensity }));
    return (jsxRuntime.jsxs(preact.Fragment, { children: [jsxRuntime.jsxs(FormFieldContext.FormFieldContext.Provider, { value: formFieldContext, children: [jsxRuntime.jsx(SelectMultipleField, { columnSpan: columnSpan, compactUserAssistance: compactUserAssistance, fieldLabel: label, hasInsideLabel: hasInsideLabel, inlineUserAssistance: inlineUserAssistance, isDropdownArrowShown: true, isDropdownSelectedOnlyView: isDropdownSelectedOnlyView, isSelectedValuesCountShown: hasSelectedValuesCount, mainFieldRef: mainFieldRef, onBlur: focusProps.onFocusOut, onFocus: focusProps.onFocusIn, onDropdownArrowClick: dropdownArrowEventHandlers.onClick, onSelectedValuesCountKeyDown: selectedValuesCountProps.onKeyDown, onSelectedValuesCountKeyUp: selectedValuesCountProps.onKeyUp, onSelectedValuesCountMouseDown: selectedValuesCountProps.onMouseDown, onSelectedValuesCountToggle: selectedValuesCountProps.onToggle, rootRef: textFieldRef, selectedValuesCount: valueItems?.length, testId: testId, ...fieldLabelProps, ...mouseProps, ...textFieldProps, children: mainFieldInput }), !useSelectCommon.isPhone() && (jsxRuntime.jsx(LiveRegion.LiveRegion, { children: shouldShowDropdown ? translations.select_closeDropdown() : undefined }))] }), dropdown] }));
