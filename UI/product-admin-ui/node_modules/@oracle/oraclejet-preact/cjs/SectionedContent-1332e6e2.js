...
const DEFAULT_SHIFT_OPTIONS = { mainAxis: false };
/**
...
const StickyPositioningDropdown = ({ children, isOpen, onPosition, ...rest }) => {
    ...
    return (jsxRuntime.jsx(Dropdown.Dropdown, { isOpen: isOpen, onPosition: handlePosition, placement: placement, shiftOptions: DEFAULT_SHIFT_OPTIONS, ...rest, children: children }));
};
...
//# sourceMappingURL=SectionedContent-1332e6e2.js.map
