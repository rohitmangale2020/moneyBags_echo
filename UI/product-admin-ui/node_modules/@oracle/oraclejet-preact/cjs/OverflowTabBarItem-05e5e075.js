...
var Icon = require('./Icon-f051ef94.js');
...
var boxalignment = require('./boxalignment-e287d370.js');
...
var useDetectTruncation = require('./useDetectTruncation-a5b9dd16.js');
...
var NavigationListLinkItem = require('./NavigationListLinkItem-dc8c5e87.js');
...
var NavigationListItem = require('./NavigationListItem-519c2932.js');
...
function BaseTabBarItem({ itemKey, label, icon, badge, metadata, severity = 'none', removeIcon, showFocusRingOverride, selectionOverride, displayOverride, labelMaxWidth, href, 'aria-controls': ariaControls, 'aria-haspopup': ariaHasPopup }) {
    ...
    const { tooltipContent, tooltipEventHandlerProps, onLogicalFocus, onLogicalBlur } = NavigationListLinkItem.useTabBarItemTooltip({ label, isDisabled: !showTooltip });
    if (showTooltip) {
    ...
    const tabBarLinkItemRenderer = () => {
        const safeHref$1 = safeHref.getSafeHref(href, 'TabBar');
        return (jsxRuntime.jsxs("span", { ref: ref, class: tabBarItem, ...mergeProps.mergeProps(pressProps, tooltipEventHandlerProps, conveyorBeltProps), style: isComplexItem ? flexDimensions : tabDimensions, children: [jsxRuntime.jsx("a", { onClick: onClickLink, class: tabBarItemLinkClasses, href: safeHref$1, "data-oj-key": itemKey, "data-oj-removable": removeIcon ? 'true' : undefined, id: tabItemPrefix + itemKey, role: "tab", tabindex: -1, "aria-controls": ariaControls, "aria-selected": isSelected, "aria-haspopup": ariaHasPopup, children: isComplexItem ? complexItemRenderer() : labelIconRenderer() }), tooltipContent] }));
    };
...
const getIsMobile = () => {
    const { deviceRenderMode } = clientHints.getClientHints();
...
//# sourceMappingURL=OverflowTabBarItem-05e5e075.js.map
