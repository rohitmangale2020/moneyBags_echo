...
var DatePickerHeader = require('./DatePickerHeader-58c96bae.js');
var MonthView = require('./MonthView-35d83e3a.js');
var YearsGridView = require('./YearsGridView-f95a1da2.js');
...
const useDatePicker = ({ isReadonly, max, min, rootRef, todayTimeZone, value, onCommit }) => {
    ...
    const changeValue = compat.useCallback((newValue) => {
