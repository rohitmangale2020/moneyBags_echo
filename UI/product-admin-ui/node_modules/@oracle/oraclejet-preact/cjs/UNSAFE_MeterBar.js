...
var useMeterDatatip = require('./useMeterDatatip-8f37694f.js');
var useKeyboardEvents = require('./useKeyboardEvents-d9528b16.js');
var meterUtils = require('./meterUtils-118d1f17.js');
...
var utils$1 = require('./utils-c5dc4bda.js');
...
function MeterBarWithDimensions({ max = 100, min = 0, value = 0, step = 1, length = '100%', width, height, size, orientation = 'horizontal', isTrackRendered = true, thresholdDisplay = 'all', indicatorSize = 1, testId, baseline, isReadonly, ...props }) {
    ...
    meterUtils.validateRange(min, max, value, step, false, isReadonly, baseline);
