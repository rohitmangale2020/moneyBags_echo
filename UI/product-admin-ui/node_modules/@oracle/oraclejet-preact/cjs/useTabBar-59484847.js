...
function useTabBar(options) {
    ...
    hooks.useEffect(() => {
        if (rootRef.current) {
            const tabKeys = collectionUtils.getItemKeysArray(rootRef.current, ITEM_SELECTOR);
    ...
    const { currentKeyProps } = useCurrentKey.useCurrentKey((element) => onRemove
        ...
        : collectionUtils.keyExtractor(element, ITEM_SELECTOR), false, false, undefined, undefined, collectionUtils.getPrevNextKeyUsingRef(rootRef, currentKey, true, ITEM_SELECTOR), collectionUtils.getPrevNextKeyUsingRef(rootRef, currentKey, false, ITEM_SELECTOR), currentKey, (detail) => {
    ...
    const { triggerProps } = useContextMenuGesture.useContextMenuGesture(({ gesture, anchor, target }) => {
        ...
        if (rootRef.current) {
            tabKeysArray = isReorderable
                ? collectionUtils.getItemKeysArray(rootRef.current, ITEM_SELECTOR)
                : undefined;
            isRemovableItem =
...
//# sourceMappingURL=useTabBar-59484847.js.map
