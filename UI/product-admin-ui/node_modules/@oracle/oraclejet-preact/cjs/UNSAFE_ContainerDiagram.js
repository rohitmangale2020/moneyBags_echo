...
/**
 * Container Diagrams are used to display a set of nested nodes and the links between them.
 */
function ContainerDiagram(props) {
    return jsxRuntime.jsx(BaseDiagram.BaseDiagram, { ...props, normalizeLinks: false });
}

exports.ContainerDiagram = ContainerDiagram;
//# sourceMappingURL=UNSAFE_ContainerDiagram.js.map
