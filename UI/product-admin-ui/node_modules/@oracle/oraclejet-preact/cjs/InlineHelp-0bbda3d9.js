...
const InlineHelpSource = ({ children, source }) => {
    const translations = useTranslationBundle.useTranslationBundle('@oracle/oraclejet-preact');
    const userAssistance_learnMoreStr = translations.userAssistance_learnMore();
    const linkText = children || userAssistance_learnMoreStr;
    ...
    const safeSource = safeHref.getSafeHref(source, 'InlineHelpSource');
    return (jsxRuntime.jsx("a", { class: classNames.classNames([classes, styles.helpSourceStyles]), target: "_blank", rel: "noopener noreferrer", href: safeSource, ...(!isTabbable && tabbableModeProps), children: linkText }));
};
...
function InlineHelp({ assistiveText, sourceLink, sourceText }) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [assistiveText && sourceLink ? (jsxRuntime.jsx("span", { class: helpTextStyles, children: assistiveText })) : (assistiveText), sourceLink && jsxRuntime.jsx(InlineHelpSource, { source: sourceLink, children: sourceText })] }));
}

exports.InlineHelp = InlineHelp;
exports.InlineHelpSource = InlineHelpSource;
//# sourceMappingURL=InlineHelp-0bbda3d9.js.map
