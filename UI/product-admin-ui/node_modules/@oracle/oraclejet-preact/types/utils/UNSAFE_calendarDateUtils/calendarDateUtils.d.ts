...
declare const toJSDateUTC: (year: number, month: IsoMonth, day: IsoDay) => Date;
 ...
 */
declare const getDaysInMonth: (month: IsoMonth | "*", year: number | "*") => 31 | 28 | 30 | 29;
/**
...
declare const removeExcessiveLiteralsFromPlaceholders: <T extends {
    value: string;
