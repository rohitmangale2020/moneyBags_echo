...
export declare const _ISO_DATE_ONLY_REGEXP: RegExp;
/**
 ...
 */
export declare function isTimeOnlyIsoString(value?: string | null): boolean;
...
export declare function getDaysInMonth(y: number, m: number): 31 | 28 | 30 | 29;
