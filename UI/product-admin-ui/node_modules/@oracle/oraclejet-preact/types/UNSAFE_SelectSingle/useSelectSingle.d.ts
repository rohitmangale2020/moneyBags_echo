 ...
 * state.
 */
export declare function useSelectSingle<K extends string | number, D extends Record<string, any>>({ addToList, advancedSearch, data, inputRef, isDisabled, isFocused: propIsFocused, isReadonly, onAddToListAction, onAdvancedSearchAction, onCommit: propOnCommit, onFilter, valueItem }: UseSelectSingleProps<K, D>): {
    ...
    collectionRendererContext: import("#PRIVATE_SelectCommon").SelectSingleCollectionRendererContext<K, D>;
