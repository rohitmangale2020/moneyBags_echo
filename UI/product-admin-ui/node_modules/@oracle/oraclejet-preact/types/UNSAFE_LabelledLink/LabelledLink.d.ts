...
export type LabelledLinkProps = {
    ...
    /**
     * TODO: Use picked props from TruncatingLink once it's public to replace the following props. JET-77369
     */
    /**
    ...
    /**
     * Specifies how the text should be truncated when it overflows.
     */
    truncation?: 'end' | 'middle' | 'none';
};
/**
 * LabelledLink component can be used to render a readonly form control field that
 * has a link for its content.
 */
export declare const LabelledLink: ({ "aria-describedby": ariaDescribedBy, children, columnSpan, href, label, labelEdge: propLabelEdge, labelStartWidth: propLabelStartWidth, lineClamp, onClick: propOnClick, target, truncation, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity }: LabelledLinkProps) => import("preact").JSX.Element;
