...
type Props = IntrinsicProps & {
    ...
    /**
     * Callback function triggered when the opening animation finishes.
     */
    onTransitionEnd?: (value: boolean) => void;
};
export declare function Dropdown({ isOpen, anchorRef, children, id, onClose, minWidth, placement, offset, onPosition, flipOptions, sizeOptions, shiftOptions, initialFocus, onTransitionEnd }: Props): JSX.Element;
export {};
