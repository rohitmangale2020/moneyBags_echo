...
export type TagCloudItemProps = {
    ...
    /**
     * @description
     * The description of the item. This is used for customizing the datatip text.
     * @ojmetadata description "The description of the item. This is used for customizing the datatip text."
