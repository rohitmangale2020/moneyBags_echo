...
export type TabLinkItemData<K extends string | number> = {
     ...
     * <p><b>Note:</b> This value is rendered as a link <code class="prettyprint">href</code>.
     * Applications are responsible for providing trusted URLs, choosing protocols appropriate for
     * their use case, and enforcing any required origin or host allowlist.</p>
     */
    href: string;
};
