...
<html lang="en-us">
  <head>
    ...
    <link rel="icon" href="styles/images/JET-Favicon-Red-32x32.png" type="image/x-icon" />
    <!-- This is injects main css file for the default theme -->
    <!-- injector:theme -->
    <link rel="stylesheet" href="styles/libs/oj/20.1.2/redwood/oj-redwood-min.css" type="text/css"/>
    <!-- endinjector -->
