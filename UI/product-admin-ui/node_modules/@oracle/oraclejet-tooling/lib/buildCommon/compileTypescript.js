...
function _generateApiDocumentation({ context }) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (generateApiDocs && (isVComponent || vComponentsInPack !== 0)) {
      ...
      const { command, args, templatesFolder } = _getExecCallParameters(context, componentName);
      util.spawn(command, args, undefined, undefined, { cwd: templatesFolder })
 ...
 * @param {object} context
 * @returns {Object} containing command args and destination folder
 */
function _getExecCallParameters(context, component) {
  ...
  return {
    ...
    args: [jsdocFile, '-c', pathToConfigFile, '-q', params],
    templatesFolder
  };
}
