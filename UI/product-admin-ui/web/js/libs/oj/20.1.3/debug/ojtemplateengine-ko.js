 ...
 * @ignore
 */
define(['knockout', 'ojs/ojkoshared', 'ojs/ojtemplateengine-utils', 'ojs/ojcore', 'ojs/ojhtmlutils', 'ojs/ojcustomelement-utils', 'ojs/ojlogger', 'ojs/ojcontext'], function (ko, BindingProviderImpl, ojtemplateengineUtils, oj, HtmlUtils, ojcustomelementUtils, Logger, Context) { 'use strict';
    ...
    class TemplateEngineKoInternal {
        ...
        _shouldSkipPropertyPath(tokens) {
            ...
            if (blockedToken) {
                Logger.warn(`Skipping template property path "${tokens.join('.')}" because it contains unsupported key "${blockedToken}".`);
                return true;
            }
            return false;
        }
