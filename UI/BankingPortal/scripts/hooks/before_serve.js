 ...
 * with /auth, /api, or /assistant are forwarded by this middleware to the existing API
...
const PROXIED_PATH = /^\/(auth|api|assistant)(\/|$)/;
...
module.exports = function beforeServe(configObj) {
  ...
  console.log(`Proxying /auth, /api, and /assistant requests to ${gatewayUrl}`);
