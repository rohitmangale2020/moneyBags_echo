...
public class DocumentServiceImpl implements DocumentService {
    ...
    private String saveFile(Long customerId, MultipartFile file) {
        try {
            ...
            String cleanFileName = originalName == null ? "document" : Paths.get(originalName).getFileName().toString();
    ...
    private DocumentResponseDto toResponse(DocumentEntity entity) {
        DocumentResponseDto dto = modelMapper.map(entity, DocumentResponseDto.class);
